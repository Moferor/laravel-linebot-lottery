...
class TheJoinEventTest extends TestCase
{
    ...
    public function testJoinEventGetReplyResultIsSuccess()
    {
        ...
        $joinEvent = new TheJoinEvent($this->baseEvent, 'RoomChats', $this->lINEBot, $this->lineTemplateBuildService);
